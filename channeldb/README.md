...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vulcanize/lnd/channeldb)
...
```bash
$ go get -u github.com/vulcanize/lnd/channeldb
```
