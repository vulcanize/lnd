...
[In this PR](https://github.com/vulcanize/lnd/pull/773) we add a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/vulcanize/lnd/aezeed
...
PASS
ok      github.com/vulcanize/lnd/aezeed  4.168s
```
