...
[![Godoc](https://godoc.org/github.com/vulcanize/lnd?status.svg)](https://godoc.org/github.com/vulcanize/lnd)
...
* Sending outgoing [onion-encrypted payments](https://github.com/vulcanize/lightning-onion)
through the network.
* Updating advertised fee schedules.
* Automatic channel management ([`autopilot`](https://github.com/vulcanize/lnd/tree/master/autopilot)).
...
## Further reading
* [Step-by-step send payment guide with docker](https://github.com/vulcanize/lnd/tree/master/docker)
* [Contribution guide](https://github.com/vulcanize/lnd/blob/master/docs/code_contribution_guidelines.md)
