...
```
$ go-fuzz-build github.com/vulcanize/lnd/lnwire/<folder name here>
```
* Now, run `go-fuzz`!!!
```
...
this earlier, `go-fuzz` found two bugs ([#310](https://github.com/vulcanize/lnd/pull/310) and [#312](https://github.com/vulcanize/lnd/pull/312)) within minutes!
