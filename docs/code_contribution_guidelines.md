...
- Changes to publicly exported packages such as
  [brontide](https://github.com/vulcanize/lnd/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/vulcanize/lnd/blob/master/lntest/harness.go)
  contained within `lnd`. For example integration tests, see
  [`lnd_test.go`](https://github.com/vulcanize/lnd/blob/master/lnd_test.go#L181). 
...
definitions, check out the [lnrpc README](https://github.com/vulcanize/lnd/blob/master/lnrpc/README.md).
...
Rejoice as you will now be listed as a [contributor](https://github.com/vulcanize/lnd/graphs/contributors)!
...
[MIT license](https://github.com/vulcanize/lnd/blob/master/LICENSE).  This is
