...
### Preliminaries
  In order to work with [`lnd`](https://github.com/vulcanize/lnd), the
...
```
go get -d github.com/vulcanize/lnd
cd $GOPATH/src/github.com/vulcanize/lnd
make && make install
```
...
Github](https://github.com/vulcanize/lnd/issues/20).
...
- _vulcanize/lnd commit:_ `08de2becf8d77fae192205172c4fb17bb09bd0dbf49e64aa323b2fcbf9fe2a35`
