...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vulcanize/lnd/lnrpc)
...
```bash
$ go get -u github.com/vulcanize/lnd/lnrpc
```
...
4. Run [`gen_protos.sh`](https://github.com/vulcanize/lnd/blob/master/lnrpc/gen_protos.sh) to generate new protobuf definitions.
